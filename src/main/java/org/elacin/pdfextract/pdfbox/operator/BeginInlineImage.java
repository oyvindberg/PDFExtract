package org.elacin.pdfextract.pdfbox.operator;
...
public class BeginInlineImage extends OperatorProcessor {
    ...
    public void process(PDFOperator operator, List<COSBase> arguments) throws IOException {
        //        System.out.println("BeginInlineImage.process :D");
        ...
        //        AffineTransform at = new AffineTransform(rotationMatrix.getValue(0, 0), rotationMatrix.getValue(0, 1), rotationMatrix.getValue(1, 0),
        //                rotationMatrix.getValue(1, 1), rotationMatrix.getValue(2, 0), rotationMatrix.getValue(2, 1));
