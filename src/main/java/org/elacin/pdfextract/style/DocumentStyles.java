...
import static org.elacin.pdfextract.util.Sorting.sortStylesById;
...
public void writeXmlRepresentation(final Appendable out,
    ...
    Collections.sort(sortedStyles, sortStylesById);
...
public Style getStyleForTextPosition(@NotNull TextPosition position) {
    ...
    StringBuffer idBuffer = new StringBuffer(font);
    idBuffer.append("-");
