...
import org.elacin.pdfextract.input.graphics.DrawingSurface;
import org.elacin.pdfextract.input.graphics.DrawingSurfaceImpl;
...
protected void processPage(@NotNull PDPage page, COSStream content) throws IOException {
    if (currentPageNo >= startPage && currentPageNo <= endPage) {
        ...
        for (ETextPosition tp : charactersForPage) {
            texts.add(tp.convertText(docContent.getStyles()));
        }
