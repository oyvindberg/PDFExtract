 ...
 * <p/>
 * A style is a collection of a font (described by a string), its X and Y sizes, and an estimate of
 * the widt of a space in this font. All these properties are immutable.
 */
