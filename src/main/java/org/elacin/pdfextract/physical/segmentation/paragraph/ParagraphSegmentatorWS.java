...
import static org.elacin.pdfextract.physical.content.AssignablePhysicalContent.BLOCK_NOT_ASSIGNED;
...
final Rectangle          pos;
final LineSegmentator    segmentator;
...
public ParagraphSegmentatorWS(PhysicalPageRegion region, LineSegmentator segmentator) {
    this.region = region;
    pos = region.getPos();
